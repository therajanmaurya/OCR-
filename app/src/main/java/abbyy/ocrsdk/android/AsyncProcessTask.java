...
public class AsyncProcessTask extends AsyncTask<String, String, Boolean> {
	...
	protected Boolean doInBackground(String... args) {
		...
		try {
			...
			restClient.applicationId = "ArabicTextRecognition";
			// You should get e-mail from ABBYY Cloud OCR SDK service with the application password
			restClient.password = "iQJPOs9BK6EvqZIBm5syK8Yl";
			
			publishProgress( "Uploading image...");
			
			String language = "Arabic"; // Comma-separated list: Japanese,English or German,French,Spanish etc.
